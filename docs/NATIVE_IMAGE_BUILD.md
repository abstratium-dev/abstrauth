...
You can run it in a kind of test mode as follows, which has sign-up disabled (except for the first account):

```
docker run -it --rm -p 8080:8080 -p 9002:9002   --network abstratium   -e QUARKUS_DATASOURCE_JDBC_URL=jdbc:mysql://abstratium-mysql:3306/abstrauth   -e QUARKUS_DATASOURCE_USERNAME=abstrauth   -e QUARKUS_DATASOURCE_PASSWORD=secret   -e OAUTH_GOOGLE_CLIENT_ID="${OAUTH_GOOGLE_CLIENT_ID}"   -e OAUTH_GOOGLE_CLIENT_SECRET="${OAUTH_GOOGLE_CLIENT_SECRET}" -e ALLOW_SIGNUP=true -e ALLOW_NATIVE_SIGNIN=true -e OAUTH_GOOGLE_REDIRECT_URI="http://localhost:4200/oauth2/callback/google" -e SMALLRYE_JWT_SIGN_KEY= -e DEFAULT_ROLES="user,abstratium-abstrauth_manage-clients,abstratium-abstrauth_manage-accounts" -e QUARKUS_MANAGEMENT_HOST=0.0.0.0 -e MP_JWT_VERIFY_PUBLICKEY= abstratium-abstrauth:native
```
