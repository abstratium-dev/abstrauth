...
describe('AuditHistoryComponent', () => {
  ...
  function createComponent(entityType: string, primaryKey: string) {
    const controllerSpy = jasmine.createSpyObj('Controller', ['getAuditHistory', 'getAuditTypes', 'getRelatedAuditHistory']);
    controllerSpy.getAuditHistory.and.returnValue(Promise.resolve(mockEntries));
    controllerSpy.getRelatedAuditHistory.and.returnValue(Promise.resolve([]));
            ...
            snapshot: {
              paramMap: {
                get: (key: string) => {
                  ...
                  if (key === 'primaryKey') return primaryKey;
                  return null;
                }
              }
            }
  ...
  describe('Initialization', () => {
    ...
    it('should call loadHistory on init with valid params', fakeAsync(() => {
      createComponent('account', 'abc-123');
  ...
  describe('Loading History', () => {
    it('should display loading state', () => {
      createComponent('account', 'abc-123');
      controller.getAuditHistory.and.returnValue(new Promise(() => {})); // never resolves
      fixture.detectChanges();
    ...
    it('should display entries after successful load', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display revision type badges', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display revision numbers', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display change note when present', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display entity field data in table', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display empty state when no entries', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getAuditHistory.and.returnValue(Promise.resolve([]));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display entity type badge in header', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display primary key in header', fakeAsync(() => {
      createComponent('account', 'abc-123');
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
  ...
  describe('Error Handling', () => {
    it('should display error on 403', fakeAsync(() => {
      createComponent('oauth_client', 'abc-123');
      controller.getAuditHistory.and.returnValue(Promise.reject({ status: 403 }));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display error on 400 with message', fakeAsync(() => {
      createComponent('nonexistent', 'abc-123');
      controller.getAuditHistory.and.returnValue(
        Promise.reject({ status: 400, error: { error: 'Unknown entity type: nonexistent' } })
      );
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should display generic error on other failures', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getAuditHistory.and.returnValue(Promise.reject({ status: 500 }));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should retry loading when retry button is clicked', fakeAsync(() => {
      ...
      controller.getAuditHistory.and.returnValue(Promise.resolve(mockEntries));
  ...
  describe('Related History (Account Roles)', () => {
    ...
    it('should load related account_role history for account entity type', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getRelatedAuditHistory.and.returnValue(Promise.resolve(mockRoleEntries));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should not load related history for non-account entity types', fakeAsync(() => {
    ...
    it('should display related entries section when loaded', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getRelatedAuditHistory.and.returnValue(Promise.resolve(mockRoleEntries));
      fixture.detectChanges();
      tick();
    ...
    it('should display related entries data', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getRelatedAuditHistory.and.returnValue(Promise.resolve(mockRoleEntries));
      fixture.detectChanges();
      tick();
    ...
    it('should show empty message when no related entries', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getRelatedAuditHistory.and.returnValue(Promise.resolve([]));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
      ...
      const relatedMessage = Array.from(infoMessages).find(
        (el: any) => el.textContent.includes('account role')
      );
      expect(relatedMessage).toBeTruthy();
    }));

    it('should handle related history error', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getRelatedAuditHistory.and.returnValue(Promise.reject({ status: 403 }));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
    ...
    it('should handle generic related history error', fakeAsync(() => {
      createComponent('account', 'abc-123');
      controller.getRelatedAuditHistory.and.returnValue(Promise.reject({ status: 500 }));
      fixture.detectChanges();
      tick();
      fixture.detectChanges();
