...
describe('OrganisationsComponent', () => {
    ...
    describe('Initialisation', () => {
        ...
        it('should call loadOrganisations on init', () => {
            ...
            vi.spyOn(controller, 'loadOrganisations').mockReturnValue(undefined);
            component.ngOnInit();
    ...
    describe('Create Organisation Form', () => {
        ...
        it('should POST to /api/organisations with correct body', async () => {
            component.toggleCreateForm();
            fixture.detectChanges();
        ...
        it('should show success toast and close form on successful create', async () => {
            component.toggleCreateForm();
            component.newOrgName = 'New Org';
            ...
            expect(toastService.success).toHaveBeenCalledWith(expect.stringContaining('New Org'));
            expect(component.showCreateForm()).toBe(false);
            expect(component.newOrgName).toBe('');
        });

        it('should show formError on 400 response', async () => {
            component.toggleCreateForm();
            ...
            httpMock.expectOne('/api/organisations').flush({ violations: [{ message: 'Name too short' }] }, { status: 400, statusText: 'Bad Request' });
            await Promise.resolve(); TestBed.flushEffects();
            await Promise.resolve(); TestBed.flushEffects();
        ...
        it('should show permission error on 403 response', async () => {
            component.toggleCreateForm();
