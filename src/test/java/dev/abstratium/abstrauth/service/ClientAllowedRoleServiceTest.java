...
public class ClientAllowedRoleServiceTest {
    ...
    public void testAddAllowedRoleWithCorrectOrg() {
        ...
        given()
            .header("Authorization", "Bearer " + token)
            .contentType("application/json")
            .body("{\"role\": \"viewer\", \"defaultAssignment\": \"all_users\", \"availableToForeignOrgs\": true}")
            .when()
    ...
    public void testAddAllowedRoleWithWrongOrgReturns404() {
        ...
        given()
            ...
            .contentType("application/json")
            .body("{\"role\": \"hacker\", \"defaultAssignment\": \"all_users\", \"availableToForeignOrgs\": true}")
            .when()
            .post("/api/clients/" + actualClientId + "/allowed-roles")
            .then()
            .statusCode(404)
    ...
    public void testAddAllowedRoleDuplicateReturns409() {
        ...
        given()
            .header("Authorization", "Bearer " + token)
            .contentType("application/json")
            .body("{\"role\": \"editor\", \"defaultAssignment\": \"not_default\", \"availableToForeignOrgs\": false}")
            .when()
            .post("/api/clients/" + actualClientId + "/allowed-roles")
            .then()
            .statusCode(201);
    ...
    public void testUpdateAllowedRoleWithWrongOrgReturns404() {
        ...
        given()
            .header("Authorization", "Bearer " + defaultToken)
            .contentType("application/json")
            .body("{\"role\": \"manager\", \"defaultAssignment\": \"not_default\", \"availableToForeignOrgs\": false}")
            .when()
            .post("/api/clients/" + actualClientId + "/allowed-roles")
            .then()
            .statusCode(201);
        ...
        given()
            .header("Authorization", "Bearer " + wrongToken)
            .contentType("application/json")
            .body("{\"defaultAssignment\": \"all_users\", \"availableToForeignOrgs\": false}")
            .when()
    ...
    public void testRemoveAllowedRoleWithWrongOrgReturns404() {
        ...
        given()
            .header("Authorization", "Bearer " + defaultToken)
            .contentType("application/json")
            .body("{\"role\": \"admin\", \"defaultAssignment\": \"not_default\", \"availableToForeignOrgs\": false}")
            .when()
            .post("/api/clients/" + actualClientId + "/allowed-roles")
            .then()
            .statusCode(201);
    ...
    public void testForeignOrgCanOnlySeeAvailableRoles() throws Exception {
        ...
        given()
            .header("Authorization", "Bearer " + ownerToken)
            .contentType("application/json")
            .body("{\"role\": \"user\", \"defaultAssignment\": \"all_users\", \"availableToForeignOrgs\": true}")
            .when()
            .post("/api/clients/" + actualClientId + "/allowed-roles")
            .then()
            .statusCode(201);
    ...
    public void testUpdateAllowedRoleToNotAvailableCascadesToClientRoles() throws Exception {
        ...
        given()
            .header("Authorization", "Bearer " + ownerToken)
            .contentType("application/json")
            .body("{\"role\": \"api-writer\", \"defaultAssignment\": \"not_default\", \"availableToForeignOrgs\": true}")
            .when()
        ...
        given()
            .header("Authorization", "Bearer " + ownerToken)
            .contentType("application/json")
            .body("{\"defaultAssignment\": \"not_default\", \"availableToForeignOrgs\": false}")
            .when()
