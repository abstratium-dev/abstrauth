...
SELECT '${default_org_uuid}', 'Default Test Org', CURRENT_TIMESTAMP
WHERE NOT EXISTS (SELECT 1 FROM T_organisations WHERE id = '${default_org_uuid}');
...
SELECT 'client-a-id', 'client-a', 'Test Client A', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
...
INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'test-client-id', 'test-client', 'Test Client', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_clients WHERE client_id = 'test-client');

INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'test_client-id', 'test_client', 'Test Client Underscore', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_clients WHERE client_id = 'test_client');

INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'client-unique-id', 'client-unique', 'Client Unique', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_clients WHERE client_id = 'client-unique');

INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'client-different-id', 'client-different', 'Client Different', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_clients WHERE client_id = 'client-different');

INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'client-x-id', 'client-x', 'Client X', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_clients WHERE client_id = 'client-x');

INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'client-y-id', 'client-y', 'Client Y', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_clients WHERE client_id = 'client-y');

INSERT INTO T_oauth_clients (id, client_id, client_name, client_type, redirect_uris, allowed_scopes, require_pkce, created_at, org_id)
SELECT 'client-z-id', 'client-z', 'Client Z', 'confidential', '["http://localhost:8080/callback"]', '["openid","profile","email"]', false, CURRENT_TIMESTAMP, '${default_org_uuid}'
...
SELECT 'client-a', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'client-a');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'client-b', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'client-b');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'test-client', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'test-client');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'test_client', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'test_client');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'client-unique', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'client-unique');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'client-different', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'client-different');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'client-x', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'client-x');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'client-y', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
WHERE NOT EXISTS (SELECT 1 FROM T_oauth_client_secrets WHERE client_id = 'client-y');

INSERT INTO T_oauth_client_secrets (client_id, secret_hash, is_active, description, created_at, org_id)
SELECT 'client-z', '$2a$10$dummyhash', TRUE, 'Test secret', CURRENT_TIMESTAMP, '${default_org_uuid}'
